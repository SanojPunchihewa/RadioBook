...
public class BasicPipelineExample {
    ...
    public static String text = "Hal woke with a start. He found himself sitting up in bed, his spine tingling. " +
            "What had roused him? A cry of some sort. The play of light and shadow in the tent told him that the camp-fire outside was still burning. " +
            "It was meant to keep off dangerous visitors. Wild animals were all about -yet the sound he had heard did not seem the voice of an animal. " +
            "Still, he could be mistaken. This was his first night in the African wilds. " +
            ...
            "Hunt had said, ‘It’s like an orchestra,’. ‘Those high violins you hear are being played by the jackals. That crazy trombone - the hyena is playing it. " +
            "The hippo is on the bass tuba. Doesn’t that wart-hog’s 'arnk-arnk-arnk' sound just like a snare drum? And listen - far away … you can just hear it, a lion on the 'cello'.’ " +
            "‘Who’s that with the saxophone?’ asked Roger. ‘The elephant. He’s good on the trumpet too.’ A sharp grinding roar made the boys jump. Whatever made it was very close to the camp. " +
            "It sounded like a rough file being dragged over the edge of a tin roof.";
    //-public static String text = "Roger was awake. Hal woke with saying, ‘What will happen to us?’. Hunt said ‘Calm down to all’.";
    //public static String text = "‘You always look so cool,’ Daisy repeated. She had told him that she loved him, and Tom Buchanan saw. He was astounded. His mouth opened a little and he looked at Gatsby and then back at Daisy as if he had just recognized her as someone he knew a long time ago. ‘You resemble the advertisement of the man,’ she went on innocently ‘You know the advertisement of the man’";

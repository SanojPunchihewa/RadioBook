...
public class BasicPipelineExample {
    ...
    //public static String text = "‘That's fair enough,’ Colonel Raymond had said.";
  ...
  public static void main(String[] args) {
    ...
    getSentences(document.sentences().size());
    System.out.println();
  ...
  static public int getSentences(int size){
    return size;
  }
}

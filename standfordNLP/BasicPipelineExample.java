...
public class BasicPipelineExample {
  ...
  public static void main(String[] args) {
    // FileInputStream fstream = new FileInputStream("story.txt");
    ...
    props.setProperty("quoteattribution.MSSieves", "det,loose,top,maj");
    props.setProperty("quoteattribution.QMSieves", "tri,dep,onename,voc,paraend,conv,sup,loose");
    props.setProperty("singleQuotes", "true");
    props.setProperty("allowEmbeddedSame", "false");
    // props.setProperty("quoteattribution.charactersPath","./familyWords.txt");
    ...
    CoreDocument document = new CoreDocument(IOUtils.stringFromFile("./story.txt"));

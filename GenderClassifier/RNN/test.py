...
from data_util import str2bool, PROJECT_DIR, N_LETTERS, N_GENDERS, name_to_tensor, ALL_GENDERS, NameGenderDataset, \
...
parser.add_argument('--weights', default='RNN/weights/old/gender_rnn_epoch47000.pth',
...
def predict(names, n_predictions=1):
    ...
    for name in names:
        ...
        for i in range(n_predictions):
            ...
            #print('%s' % (ALL_GENDERS[gender_index]))
            predictions.append(ALL_GENDERS[gender_index])
